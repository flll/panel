...
@section('content-header')
    <h1>パネル設定<small>Pterodactylをあなたの好みに合わせて設定します。</small></h1>
    <ol class="breadcrumb">
                ...
                <form action="{{ route('admin.settings') }}" method="POST">
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                <label class="control-label">2要素認証を要求する</label>
                                <div>
                                    <div class="btn-group" data-toggle="buttons">
                                        ...
                                        <label class="btn btn-primary @if ($level == 0) active @endif">
                                            <input type="radio" name="pterodactyl:auth:2fa_required" autocomplete="off" value="0" @if ($level == 0) checked @endif> 不要
                                        </label>
                                    ...
                                    <p class="text-muted"><small>有効にすると、選択されたグループに属するアカウントは、パネルを使用するために2要素認証を有効にする必要があります。</small></p>
                                </div>
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted"><small>UIコンポーネントをレンダリングする際に使用するデフォルトの言語です。</small></p>
                                </div>
                            </div>
                        </div>
                    </div>
