...
@section('content-header')
    <h1>{{ $node->name }}<small>ノードの概要情報です。</small></h1>
    <ol class="breadcrumb">
...
<div class="row">
        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                <div class="box box-danger">
                    <div class="box-header with-border">
                        <h3 class="box-title">ノードの削除</h3>
                    </div>
                    <div class="box-body">
                        <p class="no-margin">ノードを削除すると、このノードはパネルから即座に削除されます。続行するには、このノードに関連付けられているサーバーがない状態である必要があります。</p>
                    </div>
    ...
    <div class="col-sm-4">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">一目でわかる情報</h3>
            </div>
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="info-box bg-{{ $stats['disk']['css'] }}">
                            ...
                            <div class="info-box-content" style="padding: 15px 10px 0;">
                                <span class="info-box-text">割り当てられたディスクスペース</span>
                    ...
                    <div class="col-sm-12">
                        <div class="info-box bg-{{ $stats['memory']['css'] }}">
                            ...
                            <div class="info-box-content" style="padding: 15px 10px 0;">
                                <span class="info-box-text">割り当てられたメモリ</span>
